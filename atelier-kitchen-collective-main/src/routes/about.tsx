...
import rajuBhaiImg from "@/assets/Raju-Bhai.jpg";
...
function AboutPage() {
  return (
    <>
      ...
      <section className="shell pb-12 grid gap-8 md:grid-cols-12 md:items-center md:gap-8 lg:pb-16 lg:gap-12">
        <Reveal delay={200} className="md:col-span-5 md:col-start-2">
          <div className="media aspect-[4/5] rounded-sm bg-stone/10">
            <img 
              src={rajuBhaiImg} 
              alt="Raju Bhai, Owner of Dream Maker Kitchen Gallery" 
              loading="lazy" 
              width={1400} 
              height={1750} 
              className="object-cover object-top filter grayscale-[0.2] contrast-[1.05] sepia-[0.15]" 
            />
          </div>
        </Reveal>
        <Reveal delay={100} className="md:col-span-5">
          <p className="eyebrow">The Founder</p>
          <h2 className="text-h2 mt-4">Raju Bhai</h2>
          <p className="body-lg mt-4 text-foreground font-medium">
            20+ years of experience working in modular kitchens and bespoke interior manufacturing.
          </p>
          <p className="body-lg mt-3">
            Under his leadership, Dream Maker Kitchen Gallery has built a reputation for precision engineering and deep understanding of how spaces actually work. Every project benefits from two decades of hands-on problem solving, material knowledge, and an uncompromising standard of build quality.
          </p>
        </Reveal>
      </section>

...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <span
        className="hidden max-w-0 overflow-hidden whitespace-nowrap text-sm font-medium text-white opacity-0 transition-all duration-300 ease-out group-hover:block group-hover:max-w-[12rem] group-hover:opacity-100 md:block md:max-w-0 md:opacity-0 md:group-hover:max-w-[12rem] md:group-hover:opacity-100"
        aria-hidden={!hovered}
      >
        Chat on WhatsApp
      </span>
